...
namespace App\Http\Requests\Admin\WallpaperCategory;
...
class AddOrUpdateRequest extends FormRequestBase
{
    public function __construct(array $query = array(), array $request = array(), array $attributes = array(), array $cookies = array(), array $files = array(), array $server = array(), $content = null)
    {
        ...
        $this->rules_local['parent_id'] = 'required|integer|exists:wallpaper_categories,id';
    ...
    {
        if ($this->route()->getName() == 'wallpaper_categories/update') {
