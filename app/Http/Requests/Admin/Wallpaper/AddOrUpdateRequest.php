...
class AddOrUpdateRequest extends FormRequestBase
{
    public function __construct(array $query = array(), array $request = array(), array $attributes = array(), array $cookies = array(), array $files = array(), array $server = array(), $content = null)
    {
        ...
        $this->rules_local['category.*'] = 'integer|exists:wallpaper_categories,id';
    ...
    {
        if ($this->route()->getName() == 'wallpaper/update') {
            $this->rules_local['item_id'] = 'required|integer|exists:wallpapers,id';
            ...
            $this->rules_local['vendor_code'] = 'required|integer|unique:wallpapers,vendor_code';
