    ...
    <div class="content-page">
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="card-box">
                        <form id="form_save_text_section" class="form-horizontal" action="javascript:void(0);">
                            {{csrf_field()}}
                                ...
                                @foreach($page->active_lang as $item)
                                    @if ($i == 0)
                                        <div class="tab-pane active" id="{{$item->lang}}">
                                            <?php $path = 'admin.news.quote_of_day.form_'.$item->lang; ?>
                                            @include($path)
                                        </div>
                                    @else
                            ...
                            <div class="form-group">
                                <div class="pull-right">
                                    <button class="btn btn-success btn-lg" onclick="textSection.save()">Сохранить</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@endsection
@section('my_scripts')
    {!! script_ts('/assets/admin/js/project/textSection.js') !!}
@endsection
