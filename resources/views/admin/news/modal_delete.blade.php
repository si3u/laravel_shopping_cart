<div id="modal_news_delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                @if($page->route_name == 'news/update_page')
                    <a href="{{route('news/delete', ['id' => $page->item_id])}}" class="btn btn-danger">
