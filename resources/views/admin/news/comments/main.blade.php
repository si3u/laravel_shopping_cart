        ...
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                @if($page->route_name == 'news/comments/search')
                                    <li>
                    ...
                    <div class="col-xs-12">
                        @include('admin.news.comments.form_search')
                        <div class="card-box">
                                ...
                                @if(count($page->comments) > 0)
                                    @foreach($page->comments as $comment)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img width="75" height="auto" src="/assets/images/news/{{$comment->news_image}}" alt="image" class="img-responsive">
                                            </td>
                                            <td class="text-center">
                                                {{ str_limit($comment->news_topic, 25, '...') }}
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group m-b-10">
                                                    <a href="{{route('admin/news/comment/update_page', ['id' => $comment->id])}}" type="button" class="btn btn-primary waves-effect waves-light btn-sm">
