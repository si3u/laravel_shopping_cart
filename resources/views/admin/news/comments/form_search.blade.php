                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-3 control-label">ID новости</label>
                                <div class="col-md-9">
                                    <input @isset($page->old_id_news)
                                           value="{{$page->old_id_news}}"
                                       @endisset id="id_news" name="id_news" class="form-control" placeholder="Введите ID новости">
                                </div>
                            </div>
                            <div class="form-group">
