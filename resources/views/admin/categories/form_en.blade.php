<form id="form_add_en" action="{{route('admin/category/add')}}" class="form-horizontal" role="form" onclick="return false;">
    <input type="hidden" id="update_id_en" value="null">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input id="sorting_order" name="sorting_order" value="0" type="text" class="form-control" placeholder="Порядок сортировки">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <div id="description_en" name="description_en" class="summernote"></div>
        </div>
    </div>
    ...
    <div class="form-group" style="display: none;" id="group_errors_en">
        <div class="alert alert-danger alert-dismissible fade in" role="alert">
            <div class="text-left" id="errors_list_en">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            @if ($page->route_name == 'admin/categories/add')
                <div class="pull-right" id="btn_add_en">
                    <button onclick="category.add('en', 3);" class="btn btn-success btn-lg">Добавить</button>
                </div>
                <div class="pull-right" id="btn_update_en" style="display: none;">
                    <button onclick="category.update('en', 3);" class="btn btn-success btn-lg">Обновить данные</button>
                </div>
            @endif
            @if ($page->route_name == 'admin/categories/update')
                <div class="pull-right" id="btn_update_en">
                    <button onclick="category.update('en', 3);" class="btn btn-success btn-lg">Обновить данные</button>
                </div>
            @endif
        </div>
