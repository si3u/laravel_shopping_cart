<form id="form_add_ru" action="{{route('admin/category/add')}}" class="form-horizontal" role="form" onclick="return false;">
    <input type="hidden" id="update_id_ru" value="null">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <div id="description_ru" name="description_ru" class="summernote"></div>
        </div>
    </div>
    ...
    <div class="form-group" style="display: none;" id="group_errors_ru">
        <div class="alert alert-danger alert-dismissible fade in" role="alert">
            <div class="text-left" id="errors_list_ru">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            @if ($page->route_name == 'admin/categories/add')
                <div class="pull-right" id="btn_add_ru">
                    <button onclick="category.add('ru', 1);" class="btn btn-success btn-lg">Добавить</button>
                </div>
                <div class="pull-right" id="btn_update_ru" style="display: none;">
                    <button onclick="category.update('ru', 1);" class="btn btn-success btn-lg">Обновить данные</button>
                </div>
            @endif
            @if ($page->route_name == 'admin/categories/update')
                <div class="pull-right" id="btn_update_ru">
                    <button onclick="category.update('ru', 1);" class="btn btn-success btn-lg">Обновить данные</button>
                </div>
            @endif
        </div>
