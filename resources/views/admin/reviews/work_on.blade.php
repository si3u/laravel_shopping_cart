                        ...
                        <div class="card-box">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="pull-right">
                                                    <button type="button" onclick="$('#modal_review_delete').modal('show');" class="btn btn-lg btn-danger">
                                                        Удалить
                                                    </button>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <hr>
                                    <div class="thumbnail">
                                        <img src="/assets/images/products/{{$page->review->product_image}}" class="img-responsive">
                                        <div class="caption">
                                            ...
                                            <p class="text-right">
                                                <a target="_blank" href="{{route('admin/painting/update_page', ['id' => $page->review->product_id])}}" class="btn btn-lg btn-primary waves-effect waves-light" role="button">
                                                    Открыть товар
                                                </a>
                                            </p>
                                        </div>
