<div id="modal_modular_image_delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-icon alert-white alert-danger alert-dismissible fade in" role="alert">
                    ...
                    Вы действительно хотите удалить это модульное изображение?
                </div>
            </div>
