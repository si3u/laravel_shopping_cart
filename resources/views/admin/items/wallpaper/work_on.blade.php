...
@section('content')
        ...
        <div class="content">
            <div class="container">
                <div class="row">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                <li>
                                    <a href="{{route('admin/wallpapers')}}">
                                        <i class="dripicons-arrow-thin-left"></i> К фотообоям
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            @if($page->route_name == 'admin/wallpaper/add_page')
                            ...
                            @endif
                                    ...
                                    @foreach($page->active_lang as $item)
                                        @if ($i == 0)
                                            <div class="tab-pane active" id="{{$item->lang}}">
                                                <?php $path = 'admin.items.wallpaper.form_'.$item->lang; ?>
                                                @include($path)
                                            </div>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input @isset($page->item->vendor_code) value="{{$page->item->vendor_code}}" @endisset name="vendor_code" id="vendor_code" class="form-control" placeholder="Введите артикул">
                                    </div>
                                </div>
                                @if ($page->route_name == 'admin/wallpaper/add_page')
                                    <div class="form-group"
                                ...
                                @else
                                    <div class="form-group" id="group_now_image">
                                        <label class="control-label col-md-3">Текущее изображение</label>
                                        <div class="col-md-9">
                                            <img src="/assets/images/wallpapers/{{$page->item->preview_image}}" id="now_image" alt="image" class="img-responsive">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input @isset($page->item->min_width) value="{{$page->item->min_width}}" @endisset name="min_width" id="min_width" class="form-control" placeholder="Минимальная ширина">
                                            </div>
                                            <div class="col-md-6">
                                                <input @isset($page->item->max_width) value="{{$page->item->max_width}}" @endisset name="max_width" id="max_width" class="form-control" placeholder="Максимальная ширина">
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input @isset($page->item->min_height) value="{{$page->item->min_height}}" @endisset name="min_height" id="min_height" class="form-control" placeholder="Минимальная высота">
                                            </div>
                                            <div class="col-md-6">
                                                <input @isset($page->item->max_height) value="{{$page->item->max_height}}" @endisset name="max_height" id="max_height" class="form-control" placeholder="Максимальная высота">
                                            </div>
                                        </div>
                                        <span class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="pull-right">
                                            ...
                                            @else
                                                <button class="btn btn-danger btn-lg" onclick="$('#modal_wallpaper_delete').modal('show');">
                                                    Удалить
                                                </button>
    ...
    @if($page->route_name == 'admin/wallpaper/update_page')
