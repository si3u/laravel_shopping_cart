<div id="modal_wallpaper_category_delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{route('wallpaper_category/delete', ['id' => $page->category->id])}}" class="btn btn-danger">
