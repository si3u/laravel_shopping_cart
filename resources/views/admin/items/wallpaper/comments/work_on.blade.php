                        ...
                        <div class="card-box">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="pull-right">
                                                    <button onclick="$('#modal_wallpaper_comment_delete').modal('show');" class="btn btn-lg btn-danger">
                                                        Удалить
                                                    </button>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <hr>
                                    <div class="thumbnail">
                                        <img src="/assets/images/wallpapers/{{$page->comment->wallpaper_image}}" class="img-responsive">
                                        <div class="caption">
                                            <dl class="dl-horizontal">
                                                <dt>Артикул:</dt>
                                                <dd>{{$page->comment->vendor_code}}</dd>
                                                <dt>Наименование:</dt>
                                                <dd>{{$page->comment->wallpaper_name}}</dd>
                                            </dl>
                                            <p class="text-right">
                                                <a target="_blank" href="{{route('admin/wallpaper/update_page', ['id' => $page->comment->wallpaper_id])}}" class="btn btn-lg btn-primary waves-effect waves-light" role="button">
                                                    Открыть
                                                </a>
                                            </p>
                                        </div>
