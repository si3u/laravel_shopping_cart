<div id="modal_wallpaper_comment_delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                @if($page->route_name == 'wallpaper/comment/page_update')
                    <a href="{{route('wallpaper/comment/delete', ['id' => $page->comment->id])}}" class="btn btn-danger">
