<div id="modal_wallpaper_review_delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                @if($page->route_name == 'wallpaper/eview/page_update')
                    <a href="{{route('wallpaper/review/delete', ['id' => $page->review->id])}}" class="btn btn-danger">
