var wallpaper = {
    'delete': function (id) {
        console.log(id);
        $('#href_delete').attr('href', '/admin/wallpaper/delete/'+id);
        $('#modal_wallpaper_delete').modal('show');
    }
};
        ...
        if (itemId.val().length === 0) {
            $.ajax({
                ...
                error: function(XMLHttpRequest, textStatus, errorThrown) {
                    ...
                    callToast.error('Ошибка', 'при добавлении');
                    spinner.hide();
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        if (response.preview_image != undefined) {
                            ...
                            $('#now_image').attr('src', '/assets/images/wallpapers/'+response.preview_image);
                        }
                ...
                success: function(response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        if (response.new_image != undefined) {
                            $('#now_image').attr('src', '/assets/images/wallpapers/'+response.new_image);
                        }
